    ...
    <section className="site-content">
        ...
        <div className="container-1700 conteudo-site display-none">
            ...
            <div className="faq-search-header">
                ...
                <input type="text" id="search-faq" placeholder="Buscar por tema, palavra-chave ou trecho do feedback..." autoComplete="off" />
            </div>

            <p className="gray faq-sem-resultados display-none" id="faq-sem-resultados">
