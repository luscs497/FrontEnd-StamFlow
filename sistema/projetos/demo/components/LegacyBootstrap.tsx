...
//   "avulso"    -> painel.stamflow.com.br      (client SEM empresa, pagante)
//   "empregado" -> user.stamflow.com.br        (client COM empresa)
//   "gestor"    -> gestor.stamflow.com.br      (manager)
//   "demo"      -> demo.stamflow.com.br        (client SEM empresa, status DEMO)
const THIS_PANEL = "demo";
...
async function verifySession(): Promise<boolean> {
  ...
  if (tipo === "manager") {
    ...
    if (companyId != null) {
      ...
      // Cliente sem empresa: pode ser conta "avulso" (pagante/trial completo)
      // ou conta "demo" (status DEMO). /auth/me não traz o status da
      // subscription, então consultamos /account/profile só neste caso
      // específico para decidir entre os dois painéis.
      ...
      try {
        ...
        // Falha ao consultar o profile: trata como conta normal (avulso),
        // não bloqueia o acesso por uma falha de rede secundária.
      }
