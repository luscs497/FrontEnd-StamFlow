...
export const LEGACY_SCRIPTS: string[] = [
  ...
  "/scripts/auth.js",
  // CORREÇÃO DEMO: limitações da versão demo (decisão de produto, 2026-06).
  // Precisa carregar ANTES de script.js, camera.js e get-repots.js, pois
  // window.DemoGate é consultado por eles ao navegar/tocar áudio/sincronizar.
  "/scripts/demo-gate.js",
